...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pw-hints { display: grid; grid-template-columns: 1fr 1fr; gap: 4px; margin-top: 6px; font-size: .72rem; color: #64748b; }
        .pw-hint { display: flex; align-items: center; gap: 4px; }
        .pw-hint.valid { color: #16a34a; font-weight: 600; }
        .pw-hint.valid i { color: #16a34a; }
        ...
        @media (max-width: 600px) { .form-grid { grid-template-columns: 1fr; } .card { padding: 28px 22px; } .pw-hints { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
