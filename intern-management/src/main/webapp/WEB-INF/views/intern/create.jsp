...
<head>
    <meta charset="UTF-8">
    <title>Create Intern Profile - HR</title>
...
<div class="container mt-4" style="max-width: 700px;">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">Create Intern Profile</h4>
        </div>
        <div class="card-body">
            ...
            <form action="${pageContext.request.contextPath}/hr/interns/create" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="userId" class="form-control" value="${intern.userId}">
                    </div>
                </div>
